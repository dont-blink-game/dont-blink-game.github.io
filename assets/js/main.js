(() => {
    ...
    function convertEyeToTitle(cell, word, modifier) {
        ...
        if (svg) svg.remove();
        cell.classList.remove('eye', 'blinking', 'linked', 'linked-discord', 'linked-youtube', 'linked-playstore', 'linked-tiktok', 'armed');
    ...
    function createLogoGroup(svg, type) {
        ...
        const href = `assets/icons/${type}.svg`;
    ...
    function clearSpecial(cell) {
        ...
        cell.classList.remove('linked', 'linked-discord', 'linked-youtube', 'linked-playstore', 'linked-tiktok');
